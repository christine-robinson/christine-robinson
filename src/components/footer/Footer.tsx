...
const LINKS = [
  profile.github ? { label: "GitHub", href: profile.github, icon: Github } : null,
  profile.linkedin ? { label: "LinkedIn", href: profile.linkedin, icon: Linkedin } : null,
  { label: "Email", href: `mailto:${profile.email}`, icon: Mail },
].filter((l): l is { label: string; href: string; icon: typeof Mail } => l !== null);
